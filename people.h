...
public:
    ...
    People()
    {
        ...
        if (isMale)
        {
            firstName = maleFirstNames[rand() % countFirstNames];
            lastName = maleLastNames[rand() % countLastNames];
            patronymic = malePatronymics[rand() % countPatronymics];
        }
        else
        {
            firstName = femaleFirstNames[rand() % countFirstNames];
            lastName = femaleLastNames[rand() % countLastNames];
            patronymic = femalePatronymics[rand() % countPatronymics];
        }
